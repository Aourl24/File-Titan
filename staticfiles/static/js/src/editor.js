...
React.useEffect(()=>{
    ...
    return (
        ...
        <div class="row">
        <div class="col">
<div id="editor" style={{fontFamily:font,fontSize:fontsize,overFlow:'hidden',zIndex:'1000000',position:fullscreen ? 'fixed':'absolute',height:'20%',widt:'100%',top: fullscreen ?'0':'inherit',left:fullscreen ?'0':'inherit'}}></div>
        </div>
        </div>
